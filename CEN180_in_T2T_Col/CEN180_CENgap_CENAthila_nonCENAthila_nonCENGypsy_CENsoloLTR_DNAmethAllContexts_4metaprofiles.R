...
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENgap_CENAthila_nonCENAthila_nonCENGypsy_CENsoloLTR_DNAmethAllContexts_4metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' 180 2000 2000 2000 2kb 10 10 10bp 10bp '0.02,0.96' 'WT_nanopolishDNAmeth_95_10kb_MappedOn_T2T_Col_CpG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CpG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CHG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CHH' 'nanopore/T2T_Col/nanopolish_DNAmeth,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col' 'mCG (ONT),mCG (PE BS-seq),mCHG (PE BS-seq),mCHH (PE BS-seq)' 'green3,dodgerblue4,dodgerblue1,cyan2'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("WT_nanopolishDNAmeth_95_10kb_MappedOn_T2T_Col_CpG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CpG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CHG,Col0_BSseq_Rep1_MappedOn_T2T_Col_CHH",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("nanopore/T2T_Col/nanopolish_DNAmeth,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col,BSseq_seedling_Yang_Zhu_2016_CellRes/snakemake_BSseq_T2T_Col",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("mCG (ONT),mCG (PE BS-seq),mCHG (PE BS-seq),mCHH (PE BS-seq)",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("green3,dodgerblue4,dodgerblue1,cyan2",
#                               split = ","))
...
ggsave(paste0(plotDir,
              ...
              gsub("_MappedOn_T2T_Col_.+", "", ChIPNames)[2], 
              "_avgProfiles_around",
