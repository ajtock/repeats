...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENgap_CENAthila_nonCENAthila_nonCENGypsy_1sRNAsize_7metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 2kb 10 10 10bp 10bp '0.02,0.96' 'Col_0_sRNA_ERR966148,met1_3_sRNA_ERR966149,s7_Col_0_sRNA_SRR1042176,s8_ddm1_2_sRNA_SRR1042177,Col_0_sRNA_SRR1005417,drm1_drm2_cmt2_cmt3_sRNA_SRR1005420,kss_sRNA_SRR1005421' 'sRNAseq_leaf_Rigal_Mathieu_2016_PNAS/snakemake_sRNAseq_T2T_Col,sRNAseq_leaf_Rigal_Mathieu_2016_PNAS/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Creasey_Martienssen_2014_Nature/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Creasey_Martienssen_2014_Nature/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col' 'WT (Rigal et al. 2016),met1-3 (Rigal et al. 2016),WT (Creasey et al. 2014),ddm1 (Creasey et al. 2014),WT (Stroud et al. 2014),ddcc (Stroud et al. 2014),kss (Stroud et al. 2014)' 'springgreen2,magenta,forestgreen,purple4,darkgreen,blue,deepskyblue' '21'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("Col_0_sRNA_ERR966148,met1_3_sRNA_ERR966149,s7_Col_0_sRNA_SRR1042176,s8_ddm1_2_sRNA_SRR1042177,Col_0_sRNA_SRR1005417,drm1_drm2_cmt2_cmt3_sRNA_SRR1005420,kss_sRNA_SRR1005421",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("sRNAseq_leaf_Rigal_Mathieu_2016_PNAS/snakemake_sRNAseq_T2T_Col,sRNAseq_leaf_Rigal_Mathieu_2016_PNAS/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Creasey_Martienssen_2014_Nature/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Creasey_Martienssen_2014_Nature/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col,sRNAseq_floral_Stroud_Jacobsen_2014_NSMB/snakemake_sRNAseq_T2T_Col",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("WT (Rigal et al. 2016),met1-3 (Rigal et al. 2016),WT (Creasey et al. 2014),ddm1 (Creasey et al. 2014),WT (Stroud et al. 2014),ddcc (Stroud et al. 2014),kss (Stroud et al. 2014)",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("springgreen2,magenta,forestgreen,purple4,darkgreen,blue,deepskyblue",
#                               split = ","))
#sRNAsize <- unlist(strsplit("21",
#                            split = ","))
...
yLabPlot <- paste0(sRNAsize, "-nt sRNAs (TPM)")
sRNAsize <- as.character(sapply(sRNAsize, function(x) rep(x, length(ChIPNamesPlot))))
#ChIPNamesPlot <- paste0(ChIPNamesPlot, " ", sRNAsize, "-nt")
...
ggsave(paste0(plotDir,
              ...
              log2ChIPNames[1], "_", ChIPNames[length(log2ChIPNames)],
              "_avgProfiles_around",
              "_CEN180_ranLoc_CENgap_CENAthila_nonCENAthila_nonCENGypsy_in_T2T_Col_",
              paste0(chrName, collapse = "_"), "_", align, "_v210521.pdf"),
       plot = ggObjGA_combined,
