...
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("151010_Natasha_BSseq/snakemake_BSseq_T2T_Col,151010_Natasha_BSseq/snakemake_BSseq_T2T_Col",
#                                split = ","))
...
legendPos <- as.numeric(unlist(strsplit(args[10],
                                        split = ",")))
ChIPNames <- unlist(strsplit(args[11],
                             split = ","))
ChIPNamesDir <- unlist(strsplit(args[12],
                                split = ","))
log2ChIPNamesPlot <- unlist(strsplit(args[13],
                                     split = ","))
log2ChIPColours <- unlist(strsplit(args[14],
                                   split = ","))
context <- args[15]
