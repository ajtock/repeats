...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENgap_CENAthila_nonCENAthila_nonCENGypsy_CENsoloLTR_ChIP_SPO11_3metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 '2kb' 10 10 10bp 10bp '0.02,0.96' 'WT_SPO11oligos_Rep3,met1_SPO11oligos_Rep1,kss_SPO11oligos_Rep1' '160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/met1/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col' 'WT,met1-3,kss' 'springgreen2,magenta,deepskyblue' 'SPO11-1-oligos'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("WT_SPO11oligos_Rep3,met1_SPO11oligos_Rep1,kss_SPO11oligos_Rep1",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/met1/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("WT,met1-3,kss",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("springgreen2,magenta,deepskyblue",
#                               split = ","))
