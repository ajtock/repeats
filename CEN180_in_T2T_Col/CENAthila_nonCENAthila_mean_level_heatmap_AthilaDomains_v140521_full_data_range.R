...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CENAthila_nonCENAthila_mean_level_heatmap_AthilaDomains_v140521_full_data_range.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 2000 0 '0kb' 10 5LTR
...
write.table(tab_extend,
            file = paste0("/home/ajt200/analysis/nanopore/T2T_Col/annotation/TEs/",
                          "t2t_ATHILA_with_mean_RNA_sRNA_DNAmeth_H3K9me2_ATAC_SPO11_in_", Athila_domain, "_v140521.tsv"),
