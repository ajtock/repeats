...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_CENgap_SNVs_v_CEN180consensus_6metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' 180 11000 1000 1kb 10 200 10bp 10bp '0.02,0.96'
...
#                                     split = ","))
#ChIPColours <- unlist(strsplit("deepskyblue,blue,navy,tomato,red,red4",
#                                   split = ","))
...
# Load feature matrices for each variant dataset
