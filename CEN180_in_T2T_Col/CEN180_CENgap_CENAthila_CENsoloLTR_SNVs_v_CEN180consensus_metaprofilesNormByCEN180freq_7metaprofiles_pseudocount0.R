...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENgap_CENAthila_CENsoloLTR_SNVs_v_CEN180consensus_metaprofilesNormByCEN180freq_7metaprofiles_pseudocount0.R 'Chr1,Chr2,Chr3,Chr4,Chr5' 180 2000 2000 2kb 10 10 10bp 10bp '0.02,0.96'
...
#              paste0(ChIPNames, collapse = "_"),
              ...
              paste0(chrName, collapse = "_"), "_pseudocount0_ratios_all_features.pdf"),
