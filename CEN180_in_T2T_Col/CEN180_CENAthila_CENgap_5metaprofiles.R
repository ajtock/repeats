...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_CENgap_5metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 11000 1000 1kb 10 200 10bp 10bp '0.02,0.40' 'WT_SPO11oligos_Rep1,WT_SPO11oligos_Rep2,WT_SPO11oligos_Rep3,kss_SPO11oligos_Rep1,kss_SPO11oligos_Rep2' '160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col' 'wt Rep1,wt Rep2,wt Rep3,kss Rep1,kss Rep2' 'grey0,grey20,grey40,darkorange,darkorange4' 'SPO11-1-oligos'
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_CENgap_5metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 11000 1000 1kb 10 200 10bp 10bp '0.02,0.40' 'met1_SPO11oligos_Rep1,met1_SPO11oligos_Rep2,met1_SPO11oligos_Rep3,kss_SPO11oligos_Rep1,kss_SPO11oligos_Rep2' '160518_Kyuha_SPO11oligos/met1/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/met1/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/met1/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col' 'met1 Rep1,met1 Rep2,met1 Rep3,kss Rep1,kss Rep2' 'magenta,purple,purple4,darkorange,darkorange4' 'SPO11-1-oligos'
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_CENgap_5metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 11000 1000 1kb 10 200 10bp 10bp '0.02,0.40' 'WT_DMC1_V5_Rep1_ChIP,WT_DMC1_V5_Rep2_ChIP,kss_DMC1_V5_Rep1_ChIP,cmt3_DMC1_V5_Rep1_ChIP,ColLerF1_DMC1_V5_Rep1_ChIP' '20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_T2T_Col,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_T2T_Col,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_T2T_Col,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_T2T_Col,20190917_dh580_Athaliana_ChIPseq_DMC1/fastq_pooled/snakemake_ChIPseq_T2T_Col' 'wt Rep1,wt Rep2,kss Rep1,cmt3 Rep1,F1 Rep1' 'deepskyblue,navy,magenta,forestgreen,darkorange' 'DMC1'
...
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/WT/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col,160518_Kyuha_SPO11oligos/kss/snakemake_SPO11oligos_T2T_Col",
#                                split = ","))
#log2ChIPNamesPlot <- unlist(strsplit("wt Rep1,wt Rep2,wt Rep3,kss Rep1,kss Rep2",
#                                     split = ","))
#log2ChIPColours <- unlist(strsplit("deepskyblue,blue,navy,darkorange,darkorange4",
#                                   split = ","))
...
ChIPNamesDir <- unlist(strsplit(args[13],
                                split = ","))
log2ChIPNamesPlot <- unlist(strsplit(args[14],
                                     split = ","))
log2ChIPColours <- unlist(strsplit(args[15],
                                   split = ","))
yLabPlot <- args[16]
