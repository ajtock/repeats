...
# for all CEN180 sequences

# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_metaprofiles_no_ranLoc.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 1000 1kb 10 '0.02,0.96'
...
ggsave(paste0(plotDir,
              "log2ChIPcontrol_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_no_ranLoc.pdf"),
...
ggsave(paste0(plotDir,
              ChIPNames[1], "_vs_log2ChIPcontrol_avgProfiles_around",
               "_CEN180_in_RaGOO_v2.0_",
               paste0(chrName, collapse = "_"), "_", align, "_kde2d_heatmaps_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(log2ChIPNamesPlot)), width = 9, limitsize = FALSE)

#### Free up memory by removing no longer required objects
rm(
   log2ChIP_featureMats,
   log2ChIP_mats,
...
ggsave(paste0(plotDir,
              "control_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(controlNamesPlot)), width = 7, limitsize = FALSE)
...
ggsave(paste0(plotDir,
              ChIPNames[1], "_vs_control_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_kde2d_heatmaps_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(controlNamesPlot)), width = 9, limitsize = FALSE)
...
ggsave(paste0(plotDir,
              "ChIP_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(ChIPNamesPlot)), width = 7, limitsize = FALSE)
...
ggsave(paste0(plotDir,
              ChIPNames[1], "_vs_ChIP_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_kde2d_heatmaps_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(ChIPNamesPlot)), width = 9, limitsize = FALSE)
...
ggsave(paste0(plotDir,
              "DNAmeth_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(DNAmethNamesPlot)), width = 7, limitsize = FALSE)
...
ggsave(paste0(plotDir,
              ChIPNames[1], "_vs_DNAmeth_avgProfiles_around",
               ...
               paste0(chrName, collapse = "_"), "_", align, "_kde2d_heatmaps_no_ranLoc.pdf"),
       plot = ggObjGA_combined,
       height = 6.5*length(c(DNAmethNamesPlot)), width = 9, limitsize = FALSE)
...
ggsave(paste0(plotDir,
       ...
       plot = ggObj, height = 50, width = 50, limitsize = FALSE)
