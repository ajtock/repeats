...
# of recombination rate (cM/Mb) for each group of peaks

# Usage:
# /applications/R/R-3.5.0/bin/Rscript peak_cMMb_quantile_cMMb_density_mean_95CI_plot.R cMMb DMC1_Rep1_ChIP DMC1 'Agenome_euchromatin,Bgenome_euchromatin,Dgenome_euchromatin' 4
