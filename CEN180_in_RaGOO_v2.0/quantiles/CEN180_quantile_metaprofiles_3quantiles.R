...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript CEN180_quantile_metaprofiles_3quantiles.R 'Chr2' array_size 3 both 180 1000 1kb 10 '0.02,0.30'

#chrName <- unlist(strsplit("Chr2",
#                           split = ","))
#orderingFactor <- "array_size"
#quantiles <- 3
#align <- "both"
#bodyLength <- 180
#upstream <- 1000
