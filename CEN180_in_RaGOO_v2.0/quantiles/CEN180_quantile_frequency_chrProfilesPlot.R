...
filt_covProfiles <- read.table(paste0("/home/ajt200/analysis/CENH3_seedlings_Maheshwari_Comai_2017_GenomeRes/",
                                      "xiaohui_pipeline_RaGOO_v2.0/coverage/log2ChIPinput/genomeProfiles/",
                                      "filt_WT_CENH3_Rep1_ChIP_SRR4430537_WT_REC8_Myc_Rep1_input_genome_norm_coverage_",
                                      genomeBinName, "_noZscore.tsv"),
                               header = T, sep = "\t")
