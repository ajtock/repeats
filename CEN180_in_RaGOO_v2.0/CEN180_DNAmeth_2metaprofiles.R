...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_DNAmeth_2metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' 180 1000 1kb 10 '0.02,0.96' 'WT_BSseq_Rep1_ERR1039947,met1het_BSseq_Rep1_ERR1039955' '151010_Natasha_BSseq/snakemake_BSseq_RaGOO_v2.0,151010_Natasha_BSseq/snakemake_BSseq_RaGOO_v2.0' 'wt (BS-seq),met1/+ (BS-seq)' 'forestgreen,magenta' 'CpG'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("WT_BSseq_Rep1_ERR1039947,met1het_BSseq_Rep1_ERR1039955",
#                             split = ","))
...
#                                split = ","))
#log2ChIPNamesPlot <- unlist(strsplit("wt (BS-seq),met1/+ (BS-seq)",
#                                     split = ","))
#log2ChIPColours <- unlist(strsplit("forestgreen,magenta",
#                                   split = ","))
#context <- "CpG"
