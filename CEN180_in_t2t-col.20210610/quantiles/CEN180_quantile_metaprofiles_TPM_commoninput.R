...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_quantile_metaprofiles_TPM_commoninput.R 'Chr1,Chr2,Chr3,Chr4,Chr5' wSNV 4 both 180 2000 2kb 10 '0.02,0.96'
...
ggsave(paste0(plotDir,
              "log2ChIPcontrol_avgProfiles_around_", quantiles, "quantiles",
               "_by_", orderingFactor,
               "_of_CEN180_in_t2t-col.20210610_",
               paste0(chrName, collapse = "_"), "_", align, "_TPM_commoninput.pdf"),
