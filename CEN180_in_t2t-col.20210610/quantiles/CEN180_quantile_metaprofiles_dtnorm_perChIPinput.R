...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_quantile_metaprofiles_dtnorm_perChIPinput.R 'Chr1,Chr2,Chr3,Chr4,Chr5' wSNV 4 both 180 2000 2kb 10 '0.02,0.96'
