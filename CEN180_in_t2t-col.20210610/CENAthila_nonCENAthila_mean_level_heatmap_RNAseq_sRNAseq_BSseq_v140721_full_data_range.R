...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CENAthila_nonCENAthila_mean_level_heatmap_RNAseq_sRNAseq_BSseq_v140721_full_data_range.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 2000 2000 '2kb' 10
...
tab <- read.csv("/home/ajt200/analysis/nanopore/t2t-col.20210610/annotation/CENAthila/t2t-col.2021061.ATHILA_v100721.csv",
                header = T)[1:110,]
...
pdf(paste0(plotDir,
           ...
           paste0(chrName, collapse = "_"), "_mean_RNAseq_sRNAseq_DNAmeth_heatmap_colourQuantiles0.01to0.99_v140721.pdf"),
...
write.table(tab_extend,
            file = paste0("/home/ajt200/analysis/nanopore/t2t-col.20210610/annotation/CENAthila/",
                          "t2t_ATHILA_with_mean_RNA_sRNA_DNAmeth_v140721.tsv"),
