...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_nonCENAthila_nonCENGypsy_3metaprofiles_dtnorm_perChIPinput.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 '2kb' 10 10 10bp 10bp '0.02,0.96' 'WT_CENH3_Rep1_ChIP_SRR4430537,Col_CENH3_PE150_Rep1_ChIP,met1_CENH3_PE150_Rep1_ChIP' 'CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610' 'Col CENH3 (2×100 bp),Col CENH3 (2×150 bp),met1 CENH3 (2×150 bp)' 'grey50,springgreen2,magenta' 'ChIP'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("WT_CENH3_Rep1_ChIP_SRR4430537,Col_CENH3_PE150_Rep1_ChIP,met1_CENH3_PE150_Rep1_ChIP",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col CENH3 (2×100 bp),Col CENH3 (2×150 bp),met1 CENH3 (2×150 bp)",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("grey50,springgreen2,magenta",
#                               split = ","))
#yLabPlot <- "ChIP"
