...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript CENAthila_nonCENAthila_mean_level_heatmap_RNAseq_sRNAseq_BSseq_v220721_full_data_range.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 2000 2000 '2kb' 10
...
pdf(paste0(plotDir,
           ...
           paste0(chrName, collapse = "_"), "_mean_RNAseq_sRNAseq_DNAmeth_heatmap_colourQuantiles0.01to0.99_v220721.pdf"),
...
write.table(tab_extend,
            file = paste0("/home/ajt200/analysis/nanopore/t2t-col.20210610/annotation/CENAthila/",
                          "t2t_ATHILA_with_mean_RNA_sRNA_DNAmeth_v220721.tsv"),
