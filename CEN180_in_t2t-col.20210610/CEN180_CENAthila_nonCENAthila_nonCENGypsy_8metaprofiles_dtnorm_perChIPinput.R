...
# for all CEN180 sequences, CENAthila, nonCENGypsy, and randomly positioned loci

# Usage:
# /applications/R/R-4.0.0/bin/Rscript CEN180_CENAthila_nonCENAthila_nonCENGypsy_8metaprofiles_dtnorm_perChIPinput.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 '2kb' 10 10 10bp 10bp '0.02,0.96' 'WT_CENH3_Rep1_ChIP_SRR4430537,Col_CENH3_PE150_Rep1_ChIP,Col_CENH3_PE250_Rep1_ChIP,met1_CENH3_PE150_Rep1_ChIP,met1_CENH3_PE250_Rep1_ChIP,cmt2_cmt3_CENH3_PE250_Rep1_ChIP,ddc_CENH3_PE250_Rep1_ChIP,kss_CENH3_PE250_Rep1_ChIP' 'CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610' 'Col CENH3 (2×100 bp),Col CENH3 (2×150 bp),Col CENH3 (2×250 bp),met1 CENH3 (2×150 bp),met1 CENH3 (2×250 bp),cmt2 cmt3 CENH3 (2×250 bp),ddc CENH3 (2×250 bp),kss CENH3 (2×250 bp)' 'grey50,springgreen2,forestgreen,magenta,purple4,dodgerblue1,darkcyan,firebrick1' 'ChIP'
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("WT_CENH3_Rep1_ChIP_SRR4430537,Col_CENH3_PE150_Rep1_ChIP,Col_CENH3_PE250_Rep1_ChIP,met1_CENH3_PE150_Rep1_ChIP,met1_CENH3_PE250_Rep1_ChIP,cmt2_cmt3_CENH3_PE250_Rep1_ChIP,ddc_CENH3_PE250_Rep1_ChIP,kss_CENH3_PE250_Rep1_ChIP",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610,CENH3_PE250_mn359_20210908/snakemake_ChIPseq_t2t-col.20210610",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col CENH3 (2×100 bp),Col CENH3 (2×150 bp),Col CENH3 (2×250 bp),met1 CENH3 (2×150 bp),met1 CENH3 (2×250 bp),cmt2 cmt3 CENH3 (2×250 bp),ddc CENH3 (2×250 bp),kss CENH3 (2×250 bp)",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("grey50,springgreen2,forestgreen,magenta,purple4,dodgerblue1,darkcyan,firebrick1",
#                               split = ","))
#yLabPlot <- "ChIP"
...
#                     "CENH3_seedlings_Maheshwari_Comai_2017_GenomeRes/snakemake_ChIPseq_t2t-col.20210610",
                     rep("CENH3_PE150_mn359_20210818/snakemake_ChIPseq_t2t-col.20210610", 3),
...
controlColours <- c(
                    "grey50","springgreen2","magenta","forestgreen","dodgerblue1","darkcyan","firebrick1"
                   )
...
ChIP_featureMats <- mclapply(seq_along(ChIPNames), function(x) {
  lapply(seq_along(chrName), function(y) {
    as.matrix(read.table(paste0(ChIPDirs[x], "CEN180profiles/matrices/",
                                ChIPNames[x],
                                "_MappedOn_t2t-col.20210610_lowXM_", align, "_sort_dtnorm_CEN180_in_",
...
ChIP_TEsfMats <- mclapply(seq_along(ChIPNames), function(x) {
  lapply(seq_along(chrName), function(y) {
    as.matrix(read.table(paste0(ChIPDirs[x], "TEprofiles/matrices/",
                                ChIPNames[x],
                                "_MappedOn_t2t-col.20210610_lowXM_", align, "_sort_norm_nonCEN_TEs_Gypsy_LTR_in_",
                                chrName[y], "_matrix_bin", binSize, "bp_flank", flankName, ".tab"),
                         header = F, skip = 3))
  })
}, mc.cores = length(ChIPNames))
...
log2ChIP_AthilaMats <- mclapply(seq_along(ChIP_AthilaMats), function(x) {
  if ( ChIPNames[x] %in% c("WT_CENH3_Rep1_ChIP_SRR4430537") ) {
    ...
    print(paste0(ChIPNames[x], " library; using ", controlNames[3], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_AthilaMats[[x]]+1)/(control_AthilaMats[[3]]+1))
  } else if ( ChIPNames[x] %in% c("Col_CENH3_PE250_Rep1_ChIP", "met1_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[4], " for log2((ChIP+1)/(input+1)) calculation"))
...
log2ChIP_nonCENAthilaMats <- mclapply(seq_along(ChIP_nonCENAthilaMats), function(x) {
  if ( ChIPNames[x] %in% c("WT_CENH3_Rep1_ChIP_SRR4430537") ) {
    ...
    print(paste0(ChIPNames[x], " library; using ", controlNames[3], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_nonCENAthilaMats[[x]]+1)/(control_nonCENAthilaMats[[3]]+1))
  } else if ( ChIPNames[x] %in% c("Col_CENH3_PE250_Rep1_ChIP", "met1_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[4], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_nonCENAthilaMats[[x]]+1)/(control_nonCENAthilaMats[[4]]+1))
  } else if ( ChIPNames[x] %in% c("cmt2_cmt3_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[5], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_nonCENAthilaMats[[x]]+1)/(control_nonCENAthilaMats[[5]]+1))
  } else if ( ChIPNames[x] %in% c("ddc_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[6], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_nonCENAthilaMats[[x]]+1)/(control_nonCENAthilaMats[[6]]+1))
  } else if ( ChIPNames[x] %in% c("kss_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[7], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_nonCENAthilaMats[[x]]+1)/(control_nonCENAthilaMats[[7]]+1))
  }
}, mc.cores = length(ChIP_nonCENAthilaMats))
...
log2ChIP_TEsfMats <- mclapply(seq_along(ChIP_TEsfMats), function(x) {
  if ( ChIPNames[x] %in% c("WT_CENH3_Rep1_ChIP_SRR4430537") ) {
    ...
    print(paste0(ChIPNames[x], " library; using ", controlNames[3], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_TEsfMats[[x]]+1)/(control_TEsfMats[[3]]+1))
  } else if ( ChIPNames[x] %in% c("Col_CENH3_PE250_Rep1_ChIP", "met1_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[4], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_TEsfMats[[x]]+1)/(control_TEsfMats[[4]]+1))
  } else if ( ChIPNames[x] %in% c("cmt2_cmt3_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[5], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_TEsfMats[[x]]+1)/(control_TEsfMats[[5]]+1))
  } else if ( ChIPNames[x] %in% c("ddc_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[6], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_TEsfMats[[x]]+1)/(control_TEsfMats[[6]]+1))
  } else if ( ChIPNames[x] %in% c("kss_CENH3_PE250_Rep1_ChIP") ) {
    print(paste0(ChIPNames[x], " library; using ", controlNames[7], " for log2((ChIP+1)/(input+1)) calculation"))
    log2((ChIP_TEsfMats[[x]]+1)/(control_TEsfMats[[7]]+1))
  }
}, mc.cores = length(ChIP_TEsfMats))
...
ggsave(paste0(plotDir,
              ...
              paste0(chrName, collapse = "_"), "_", align, "_dtnorm_perChIPinput.pdf"),
...
ggsave(paste0(plotDir,
              ...
              "_avgProfiles_around",
              "_CEN180_ranLoc_CENAthila_nonCENAthila_nonCENGypsy_in_t2t-col.20210610_",
              paste0(chrName, collapse = "_"), "_", align, "_dtnorm.pdf"),
       plot = ggObjGA_combined,
       height = 6.5, width = 7*5, limitsize = FALSE)
